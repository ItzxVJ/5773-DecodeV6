...
public class RedFar15 {

    /* ---------------- START ---------------- */

    public static Pose start = new Pose(-54.2, -7.1, -1.57);

    /* ---------------- SHOOT / INTAKE POSES ---------------- */

    public static Pose firstShootPos = new Pose(-44.3, -7.4, -1.55);

    public static Pose intake1Control = new Pose(-26.8, -19, -1.55);
    public static Pose intake1 = new Pose(-26.8, -43, -1.56);


    public static Pose secondShootPos = firstShootPos;
    public static Pose rawIntake2 = new Pose(-51, -50.2, -2.08);


    public static Pose thirdShootPos = firstShootPos;

    public static Pose rawIntake3Control = new Pose(-15, -35, -1.59);
    public static Pose rawIntake3 = new Pose(-53.3, -60, -3.14);
    ...
    public static Pose park = new Pose(-38.1, -7, -1.55);
